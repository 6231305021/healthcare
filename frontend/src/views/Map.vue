...
export default {
  ...
  methods: {
    ...
    async fetchUsers() {
      try {
        const res = await axios.get('https://healthcare-production-1567.up.railway.app/auth/users');
          ...
          const popupContent = `
            <div class="popup-content">
              ...
              ${user.isPatient && user.image_path ? 
                `<img src="https://healthcare-production-1567.up.railway.app/auth/${user.image_path}" alt="รูปผู้ป่วย">` : ''}
